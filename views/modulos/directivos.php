<section id="directivos" class="team section-bg">
    <div class="container" data-aos="fade-up">

        <div class="section-title">
            <h2>Directorio</h2>
            <p>Pincipales Directivos</p>
        </div>
        ...
        <div class="row">
            ...
            <?php
            $band = 0;
            foreach ($directivos as $jey => $cargos) {
                if ($band <= 3) {
            ?>
        ...
        <div class="row">
            <?php
            $band2 = 0;
            foreach ($directivos as $jey => $cargos2) {
                if ($band2 > 3) {
                    if ($band2 < 8) {
            ?>
                        <div class="col-xl-3 col-lg-4 col-md-6">
