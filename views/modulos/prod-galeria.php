<section id="products" class="contact section-bg">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row ">
            <div id="simpleCardCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-control-prev" type="button" data-bs-target="#simpleCardCarousel" data-bs-slide="prev">
                    <i class="fa-solid fa-user"></i>
                </div>
                <div class="carousel-control-next" type="button" data-bs-target="#simpleCardCarousel" data-bs-slide="next">
